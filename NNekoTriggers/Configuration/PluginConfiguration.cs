...
namespace NNekoTriggers.Configuration
{
    ...
    internal sealed class CharacterConfiguration
    {
        ...
        public float ZoneDisplayDelay = 1.5f;
        ...
        public CustomCommand ZoneCommand1 = new();
        public CustomCommand ZoneCommand2 = new();
        public CustomCommand ZoneCommand3 = new();
        public string ZoneDisplayText1 = string.Empty;
        public string ZoneDisplayText2 = string.Empty;
        public string ZoneDisplayText3 = string.Empty;
